...
const regions = [{'default': 0}, {'iad': 1}, {'eat': 2}, {'lux': 3}, {'kr': 4}, {'sgp-1': 5}, {'dxb': 6}, {'syd': 7},
  {'sto': 8}, {'vie': 9}, {'gru': 10}, {'cpt-1': 11}, {'chile': 14}, {'peru': 15}, {'india': 16}, {'jp': 19}]
...
function updateSitngo (data) {
  return new Promise((resolve, reject) => {
    Sitngo.dynamodb().update({id: data['id'], status: data['status'], metadata: data['metadata']}, {overwrite: true}, function (err, data) {
      if (err === null) {
        resolve(data)
      } else {
        reject(err)
